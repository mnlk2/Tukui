...
if C["datatext"].specswitch and C["datatext"].specswitch > 0 then
...
T.PP(C["datatext"].specswitch, Text)

local talent = {}
local active
local talentString = string.join("", "|cffFFFFFF%s:|r ", T.ValColor, "%d|r/", T.ValColor, "%d|r/", T.ValColor, "%d|r")
