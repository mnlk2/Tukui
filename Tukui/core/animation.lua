...
T.AnimGroup = function (self,x,y,duration)
...
T.SlideOut = function(self)
	...
	self.anim:Stop()
	self.anim_o:Play()
	 if IsAddOnLoaded("Recount") and self:GetName() == "Logbg" then
	    OmenBarList:Show()
...
T.SlideIn = function(self)
	...
	self.anim:Play()
	 if IsAddOnLoaded("Recount") and self:GetName() == "Logbg" then
      ...
      ChatFrame2:Width(Logbg:GetWidth() -3)
      ChatFrame2:Height(Logbg:GetHeight() -27)
		end
end
